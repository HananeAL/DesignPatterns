...
public class SmartHome {
	...
	public String toString() {
		return "SmartHome [name=" + name + ", serialNumber=" + serialNumber + ", addressName=" + addressName
				+ ", addressNumber=" + addressNumber + ", city=" + city + ", country=" + country + ", postalCode="
				+ postalCode + ", light1PortNum=" + light1PortNum + ", light2PortNum=" + light2PortNum
				+ ", door1PortNum=" + door1PortNum + ", door2PortNum=" + door2PortNum + ", microwavePortNum="
				+ microwavePortNum + ", tvPortNum=" + tvPortNum + ", waterHeaterPortNum=" + waterHeaterPortNum + "]";
	}
	...
	public static class SmartHomeBuilder {
		...
		public Object withDoor1PortNum(int door1PortNum) {
